                ...
                <div class="row bg-secondary " style="height:76vh">
                    ...
                    <div class="col-6 bg-info">
                        <div class="row flex-column justify-content-center align-items-center ">
                            ...
                            <div class="col mt-5 text-light" style="font-size:20px;">
                                Admin Name:
                            </div>
                            ...
                            <div class=" col mt-1 text-light">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="adminName" placeholder="Email" class="form-control mr-5"
                                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                </div>
                            </div>
                            <div class="col mt-4 text-light" style="font-size:20px;">
                                Admin Password:
                            </div>
                            ...
                            <div class=" col  mt-5 d-flex justify-content-center align-items-center">
                                ...
                                <button type="submit" class="btn btn-outline-dark btn-light"
                                    style="width:300px;font-size: 20px;">Login</button>


                            </div>
                            <div class="col mt-4 text-light d-flex justify-content-around "
                                style="font-size: 16px;text-decoration: none;">
                                <a href="AdminRegisterForm.jsp" style="color:white;">SignUp</a>
