			...
			<div class="col-md-6 col-12">
				...
				<div class="row justify-content-center" style="margin-top: 80px">
					...
					<div class="col-6 row justify-content-center">
						<a class="btn btn-lg btn-warning" href="AddBusForm.jsp" style="text-decoration: none;">Add Buses</a>
					</div>
					
					<div class="col-6 row justify-content-center">
						<a class="btn btn-lg btn-warning" href="ListBusForm.jsp" style="text-decoration: none;">Show Buses</a>
					</div>
